...
/**
 * Servlet implementation class BackstageBclassInsertServlet
 */
@WebServlet("/backstageBclassInsertServlet")
public class BackstageBclassInsertServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BackstageBclassInsertServlet() {
        super();
				 ...
				 try {
				    ...
				    // 通过最后一个"\"的下标截取文件名
						if(index>0){
							...
							System.out.println("name："+name);//feature.xml
						}
			        ...
			        //   上传文件写入磁盘中( 将“upload”文件夹中名字为name的文件写入磁盘 )
			           ...
			           System.out.println("file2："+file2+"--"+name);
